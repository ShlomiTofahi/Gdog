...
class CoverImage extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                    <div className="main-box box1" style={{ backgroundImage: `url(${this.state.path}cover_image.jfif)`, right: '0' }} />
                    <Container>
                        <div className="grid-container">
                            <Link onClick={this.dogItems} align='center' style={{ textDecoration: 'none' }} to='/products'>
                                <div className="box box2" style={{ backgroundImage: `url(${this.state.path}dog.jpg)` }}>
                            ...
                            <Link onClick={this.catItems} align='center' style={{ textDecoration: 'none' }} to='/products'>
                                <div className="box box2" style={{ backgroundImage: `url(${this.state.path}cat.jpg)` }}>
                            ...
                            <Link onClick={this.catItems} align='center' style={{ textDecoration: 'none' }} to='/haircut'>
                                <div className="box box2" style={{ backgroundImage: `url(${this.state.path}haircut-dog.jpg)` }} >
                            ...
                            <Link onClick={this.catItems} align='center' style={{ textDecoration: 'none' }} to='/forum'>
                                <div className="box box2" style={{ backgroundImage: `url(${this.state.path}forum.jpg)` }} >
                            ...
                            <Link onClick={this.catItems} align='center' style={{ textDecoration: 'none' }} to='/about'>
                                <div className="box box2" style={{ backgroundImage: `url(${this.state.path}about-us.jpg)` }} >
                            ...
                            <Link onClick={this.catItems} align='center' style={{ textDecoration: 'none' }} to='/contact'>
                                <div className="box box2" style={{ backgroundImage: `url(${this.state.path}dog-phone.jpg)`,  }} >
